...
export default function Contact() {
  ...
  try {
    const response = await fetch("https://formspree.io/f/xzzvdavq", {
      method: "POST",
      headers: {
    ...
    alert("Failed to send. Please check your internet connection or try later.");
  }
};
  ...
  return (
    <section id="contact" className="py-20 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {[
                { icon: <Mail />, label: 'Email', value: 'gotteghallinanjapp.y@northeastern.edu' },
                { icon: <Phone />, label: 'Phone', value: '+1 (857) 313-0585' },
      ...
      <div>
      <footer className="text-center py-4 mt-16 text-gray-600 dark:text-gray-400">
      © Copyright 2025 Yatish Gotteghalli Nanjappa
    </footer>
    </div>
    </section>    
  );
